...
// ── API Instance ──────────────────────────────────────────────────────────────
const depositeUnverifiedService = new Api({ baseURL: apiUrl });
...
depositeUnverifiedService.instance.interceptors.request.use(
  customRequestInterceptor,
);
depositeUnverifiedService.instance.interceptors.response.use(
  successResponseInterceptor,
  errorResponseInterceptor,
);

export default depositeUnverifiedService;
