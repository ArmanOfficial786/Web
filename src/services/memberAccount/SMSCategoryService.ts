...
// ── API Instance ──────────────────────────────────────────────────────────────
const smsCategoryService = new Api({ baseURL: apiUrl });
...
smsCategoryService.instance.interceptors.request.use(customRequestInterceptor);
smsCategoryService.instance.interceptors.response.use(
  successResponseInterceptor,
  errorResponseInterceptor,
);

export default smsCategoryService;
