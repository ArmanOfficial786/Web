...
// ── API Instance ──────────────────────────────────────────────────────────────
const memberBloodGroupService = new Api({ baseURL: apiUrl });
...
memberBloodGroupService.instance.interceptors.request.use(
  customRequestInterceptor,
);
memberBloodGroupService.instance.interceptors.response.use(
  successResponseInterceptor,
  errorResponseInterceptor,
);

export default memberBloodGroupService;
