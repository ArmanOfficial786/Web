...
const shareService = new Api({ baseURL: apiUrl });
...
shareService.instance.interceptors.request.use(customRequestInterceptor);
shareService.instance.interceptors.response.use(
  successResponseInterceptor,
  errorResponseInterceptor,
);
