...
// ── API Instance ──────────────────────────────────────────────────────────────
const savingAcWiseBalanceService = new Api({ baseURL: apiUrl });
...
savingAcWiseBalanceService.instance.interceptors.request.use(
  customRequestInterceptor,
);
savingAcWiseBalanceService.instance.interceptors.response.use(
  successResponseInterceptor,
  errorResponseInterceptor,
);

export default savingAcWiseBalanceService;
