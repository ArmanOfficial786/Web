...
const translations: Record<Language, Translations> = {
  en: {
    ...
    clickGenerateReport: 'Click "Generate Report" to view the transaction report',
  ...
  np: {
    ...
    clickGenerateReport: 'कारोबार रिपोर्ट हेर्न "रिपोर्ट उत्पन्न गर्नुहोस्" क्लिक गर्नुहोस्',
