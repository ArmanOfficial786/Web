...
//   // Sample branches - replace with API call
...
//   return (
//     // <div className="w-[25rem] h-[30rem] flex justify-center  items-center   bg-white mt-20">
//     <div className="w-[25rem] h-[30rem] flex justify-center items-center rounded-lg shadow-xl bg-amber-300">
...
//           <div className="relative">
//             <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
//               <BusinessIcon sx={{ fontSize: 20 }} className="text-gray-400" />
//             </div>
//             <select
//               {...register("branchId")}
//               className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors appearance-none ${
//                 errors.branchId
//                   ? "border-red-500 focus:border-red-500 focus:ring-red-200"
//                   : "border-gray-300 focus:border-blue-500 focus:ring-blue-200 dark:border-gray-600"
...
//           type="submit"
//           disabled={loading}
//           className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
//         >
//           {loading ? (
