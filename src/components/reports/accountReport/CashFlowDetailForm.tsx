// components/reports/accountReport/CashFlowDetailsForm.tsx
"use client";
...
interface CashFlowDetailsFormProps {
  control: Control<CashFlowDetailsFormValues>;
  handleSubmit: UseFormHandleSubmit<CashFlowDetailsFormValues>;
  onSubmit: SubmitHandler<CashFlowDetailsFormValues>;
  setValue: UseFormSetValue<CashFlowDetailsFormValues>;
  reset: UseFormReset<CashFlowDetailsFormValues>;
  reportState: CashFlowDetailsResponseExtended;
  onPageChange: (page: number) => void;
  onDownload: (format: ReportFormat) => void | Promise<void>;
}

function CashFlowDetailsForm({
  control,
  handleSubmit,
  onSubmit,
  setValue,
    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Paper variant="outlined" sx={{ px: 2, py: 1 }}>
          ...
          >
            <OfficeNameField<CashFlowDetailsFormValues>
              control={control}
              branchFieldName="branchId"
            />
            <SameCompanyField<CashFlowDetailsFormValues>
              control={control}
              labelPlacement="end"
            />
          </Box>
          ...
          <Grid container spacing={1} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              <Box
                ...
                width="100%"
              >
                <ViewReportButton<CashFlowDetailsFormValues>
                  control={control}
...
export default React.memo(CashFlowDetailsForm);
