...
import {
  ShareStatementFormValues,
  ShareStatementResponseExtended,
} from "@/app/(home)/(sidebar)/Share/ShareStatementReports/page";
...
interface ShareStatementFormProps {
  control: Control<ShareStatementFormValues>;
  handleSubmit: UseFormHandleSubmit<ShareStatementFormValues>;
  onSubmit: SubmitHandler<ShareStatementFormValues>;
  setValue: UseFormSetValue<ShareStatementFormValues>;
  reset: UseFormReset<ShareStatementFormValues>;
  reportState: ShareStatementResponseExtended;
  onPageChange: (page: number) => void;
  onDownload: (format: ReportFormat) => void | Promise<void>;
}

function ShareStatementForm({
  control,
  handleSubmit,
  onSubmit,
  setValue,
  ...
  const memberLookupConfig = useMemo(
    () => MemberLookupConfig<ShareStatementFormValues>(),
    [],
  );
    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Paper variant="outlined" sx={{ px: 2, py: 1 }}>
          ...
          >
            <VisualReportSwitch<ShareStatementFormValues>
              control={control}
              name="visualReport"
            />
          </Box>
          ...
          <Grid container spacing={1} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              <Box
                ...
                width="100%"
              >
                <ViewReportButton<ShareStatementFormValues>
                  control={control}
...
export default React.memo(ShareStatementForm);
