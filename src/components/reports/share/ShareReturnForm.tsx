...
import {
  ShareReturnFormValues,
  ShareReturnResponseExtended,
...
interface ShareReturnFormProps {
  control: Control<ShareReturnFormValues>;
  handleSubmit: UseFormHandleSubmit<ShareReturnFormValues>;
  onSubmit: SubmitHandler<ShareReturnFormValues>;
  setValue: UseFormSetValue<ShareReturnFormValues>;
  reset: UseFormReset<ShareReturnFormValues>;
  reportState: ShareReturnResponseExtended;
  onPageChange: (page: number) => void;
  onDownload: (format: ReportFormat) => void | Promise<void>;
}

function ShareReturnForm({
  control,
  handleSubmit,
  onSubmit,
  setValue,
    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Paper variant="outlined" sx={{ px: 2, py: 1 }}>
          ...
          <Box sx={{ mb: 0.5 }}>
            <DateFields<ShareReturnFormValues>
              control={control}
          ...
          >
            <SoleSelectGroupField<ShareReturnFormValues>
              control={control}
              setValue={setValue}
              branchFieldName="officeId"
              groupFieldName="memberGroupId"
            />
            <OrderByField<ShareReturnFormValues>
              control={control}
              name="orderBy"
              reportKey="share-return-report"
            />
          </Box>
          <Divider sx={{ mb: 0.5 }} />
          ...
          >
            <VisualReportSwitch<ShareReturnFormValues>
              control={control}
              name="visualReport"
            />
            <Grid size={{ xs: 12, md: 6 }}>
              <Box
                ...
                width="100%"
              >
                <ViewReportButton<ShareReturnFormValues>
                  control={control}
...
export default React.memo(ShareReturnForm);
