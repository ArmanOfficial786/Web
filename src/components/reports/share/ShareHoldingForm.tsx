...
import {
  ShareHoldingFormValues,
  ShareHoldingResponseExtended,
} from "@/app/(home)/(sidebar)/Share/ShareHoldingReport/page";
...
interface ShareHoldingFormProps {
  control: Control<ShareHoldingFormValues>;
  handleSubmit: UseFormHandleSubmit<ShareHoldingFormValues>;
  onSubmit: SubmitHandler<ShareHoldingFormValues>;
  setValue: UseFormSetValue<ShareHoldingFormValues>;
  reset: UseFormReset<ShareHoldingFormValues>;
  reportState: ShareHoldingResponseExtended;
...
function ShareHoldingForm({
  ...
  const memberLookupConfig = useMemo(
    () => MemberLookupConfig<ShareHoldingFormValues>(),
    [],
  );
    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Paper variant="outlined" sx={{ px: 2, py: 1 }}>
          ...
          <Box sx={{ mb: 0.5 }}>
            <DateFields<ShareHoldingFormValues>
              control={control}
          ...
          >
            <OfficeNameField<ShareHoldingFormValues>
              control={control}
          ...
          >
            <SoleSelectGroupField<ShareHoldingFormValues>
              control={control}
              setValue={setValue}
              branchFieldName="officeId"
              groupFieldName="memberGroupId"
            />
            <MemberTypeField<ShareHoldingFormValues>
              control={control}
          ...
          >
            <OrderByField<ShareHoldingFormValues>
              control={control}
              name="orderBy"
              reportKey="share-holding-report"
            />
            <VisualReportSwitch<ShareHoldingFormValues>
              control={control}
              name="visualReport"
            />
          </Box>
          ...
          <Grid container spacing={1} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              <Box
                ...
                width="100%"
              >
                <ViewReportButton<ShareHoldingFormValues>
                  control={control}
...
export default React.memo(ShareHoldingForm);
