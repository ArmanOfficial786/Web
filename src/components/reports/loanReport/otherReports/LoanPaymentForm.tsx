...
interface LoanPaymentFormProps {
  ...
  handleSubmit: UseFormHandleSubmit<LoanPaymentFormValues>;
  onSubmit: SubmitHandler<LoanPaymentFormValues>;
  setValue: UseFormSetValue<LoanPaymentFormValues>;
  reset: UseFormReset<LoanPaymentFormValues>;
  reportState: LoanPaymentResponseExtended;
    ...
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Paper variant="outlined" sx={{ px: 2, py: 1 }}>
          ...
          {/* ── From/To Date ─────────────────────────────────────────────── */}
          <Box sx={{ mb: 0.5 }}>
            <DateFields<LoanPaymentFormValues>
              control={control}
          ...
          >
            <OfficeNameField<LoanPaymentFormValues>
              control={control}
              branchFieldName="branchIds"
              multiple={false}
            />
            <SoleSelectGroupField<LoanPaymentFormValues>
              control={control}
              setValue={setValue}
              branchFieldName="branchIds"
          ...
          >
            <FieldRow label="Payment By">
              <RadioInput
                name="paymentBy"
                control={control}
                radioOptions={paymentByOptions}
                row
              />
            </FieldRow>
            <OrderByField<LoanPaymentFormValues>
              control={control}
              name="orderBy"
              reportKey="loan-payment-report" // ⚠️ confirm this key against memberOrderByOptions.ts
            />
          </Box>
          <Divider sx={{ mb: 0.5 }} />
          ...
          >
            <Grid size={{ xs: 12, md: 6 }}>
              <Box
                ...
                width="100%"
              >
                <ViewReportButton<LoanPaymentFormValues>
                  control={control}
...
export default React.memo(LoanPaymentForm);
